...
int main()
{
    ...
    Employee tar("Tanvir constructor", 344, 324432);
    tar.name = "tanvir";
    tar.salary = 100;
    tar.printDetails();
    tar.getSecretPassword();
    //cout<<har.secretPassword;
    cout<<"The name of our first employee is "<< tar.name << " and his salary is "<<tar.salary<<" Dollars"<<endl;
